...
public final class AdditionalArmorMaterial {
  ...
  public static final ArmorMaterial GOLDEN_CHAIN = EnumHelper.addArmorMaterial("GOLDEN_CHAIN", "golden_chain", 0, new int[]{0, 0, 0, 0}, 0, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0F);
