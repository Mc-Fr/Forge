...
public abstract class McfrBlockWall extends McfrBlock implements IBlockWithVariants {
  ...
  public McfrBlockWall(String materialName, Material material, SoundType sound, float hardness, float resistance, String tool, int harvestLevel) {
    super(materialName + "_wall", material, sound, hardness, resistance, tool, harvestLevel, CreativeTabs.BUILDING_BLOCKS);
