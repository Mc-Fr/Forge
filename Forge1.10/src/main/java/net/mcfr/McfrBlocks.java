...
import net.mcfr.decoration.BlockFeathers;
import net.mcfr.decoration.BlockHangedLadder;
import net.mcfr.decoration.BlockMoucharabieh;
import net.mcfr.decoration.BlockMoucharabiehPane;
import net.mcfr.decoration.BlockPebbles;
import net.mcfr.decoration.BlockRope;
import net.mcfr.decoration.BlockRopeAttach;
import net.mcfr.decoration.BlockSmokeGenerator;
import net.mcfr.decoration.BlockSupport;
import net.mcfr.decoration.McfrBlockCarpet;
import net.mcfr.decoration.McfrBlockFence;
...
public final class McfrBlocks {
  ...
  // Tabourets
  public static final BlockWoodenChair OAK_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.OAK, "stool");
  public static final BlockWoodenChair SPRUCE_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.SPRUCE, "stool");
  public static final BlockWoodenChair BIRCH_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.BIRCH, "stool");
  public static final BlockWoodenChair JUNGLE_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.JUNGLE, "stool");
  public static final BlockWoodenChair ACACIA_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.ACACIA, "stool");
  public static final BlockWoodenChair DARK_OAK_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.DARK_OAK, "stool");
  public static final BlockWoodenChair TALL_OAK_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.OAK, "tall_stool");
  public static final BlockWoodenChair TALL_SPRUCE_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.SPRUCE, "tall_stool");
  public static final BlockWoodenChair TALL_BIRCH_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.BIRCH, "tall_stool");
  public static final BlockWoodenChair TALL_JUNGLE_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.JUNGLE, "tall_stool");
  public static final BlockWoodenChair TALL_ACACIA_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.ACACIA, "tall_stool");
  public static final BlockWoodenChair TALL_DARK_OAK_STOOL = new BlockWoodenChair(BlockPlanks.EnumType.DARK_OAK, "tall_stool");
  // Fauteuils
  public static final BlockChair WOODEN_ARMCHAIR = new BlockChair("wooden_armchair", Material.WOOD, SoundType.WOOD, 2, 5, "axe", 0);
  public static final BlockChair STONE_ARMCHAIR = new BlockChair("stone_armchair", Material.ROCK, SoundType.STONE, 2.5f, 5, "pickaxe", 0);
  // Bancs
