...
public class EntityGalt extends EntityBurrowed {
  ...
  protected void initEntityAI() {
    ...
    this.targetTasks.addTask(2, new EntityAINearestAttackableTarget<EntityNiale>(this, EntityNiale.class, true));
    this.targetTasks.addTask(2, new EntityAINearestAttackableTarget<EntityHoen>(this, EntityHoen.class, true));
  }
