...
public class BlockBench extends BlockWoodenChair {
  ...
  public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
    return state.withProperty(NORTH, isBench(worldIn, pos.north())).withProperty(EAST, isBench(worldIn, pos.east()))
        .withProperty(SOUTH, isBench(worldIn, pos.south())).withProperty(WEST, isBench(worldIn, pos.west()));
  }
